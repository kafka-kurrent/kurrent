      ...
      <div id='about'>
        ...
        <div className='aboutSum'>
          <h4>
            ...
            developers an easy and intuitive means for monitoring the health and
            throughput of their Kafka cluster.
          </h4>
        </div>
        <ul>
          <li className='topLi'>
          ...
          <li>
            Prometheus Integration: Kurrent provides a sample Prometheus yaml to
            make it easy to setup your Kafka clusters for metrics monitoring
          </li>
        </ul>
        ...
        <span className='metricSpan'>
          <div className='aboutSection'>
            ...
            <img src={metricsDemoGif} alt='metrics demo gif' id='metricsGif' />
          </div>
        </span>
      </div>
      <div id='team'>
